...
/*运动控制*/
/*左前*/
#define LEFT_GO FRONT_RIGHT_F_SET; FRONT_RIGHT_B_RESET
/*左后*/
#define LEFT_BACK FRONT_RIGHT_F_RESET;  FRONT_RIGHT_B_SET
/*左停止*/
#define LEFT_STOP FRONT_RIGHT_F_RESET; FRONT_RIGHT_B_RESET
/*右前*/
#define RIGHT_GO  BEHIND_LEFT_F_SET; BEHIND_LEFT_B_RESET 
/*右后*/
#define RIGHT_BACK BEHIND_LEFT_F_RESET;  BEHIND_LEFT_B_SET
/*右停止*/
