...
void CarGo(void)
{
	front_right_speed_duty=SPEED_DUTY;  //右前进
	behind_left_speed_duty=SPEED_DUTY; //左前进
}

//后退
void CarBack(void)
{
	front_right_speed_duty=-SPEED_DUTY; //右后退
	behind_left_speed_duty=-SPEED_DUTY; //左后退
}
...
void CarRight(void)
{
	...
	behind_left_speed_duty=SPEED_DUTY+10;//增加后轮驱动力  左前进
}
